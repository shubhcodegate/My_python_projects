...
def run(config_path):
    ...
    winner = p.run(playGame,500)     # Winner is genome object . Use pickle (import pickle) to save this winner genome. then unpickle and use wherever you want
    print('\nBest genome:\n{!s}'.format(winner))
    return winner
...
if __name__ == "__main__":
    ...
    myWinnerGenome = open(os.path.join(local_dir,"myWinnerGenome500p10000"),'xb')
